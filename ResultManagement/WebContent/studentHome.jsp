...
try{
	...
	PreparedStatement ps = con.prepareStatement("SELECT  * FROM student INNER JOIN result ON student.roll_Num = result.roll_num WHERE student.roll_num = ?") ;
	...
	//ps.getResultSet();
	//ResultSet rs=st.executeQuery("select * from student inner join result on student.roll_num = result.roll_num where student.roll_num = " + rollNo);
	
	
	//String s="select * from student inner join result where student.roll_no=result.roll_no and student.roll_no'"+rollNo+"'";	
	//out.println(s);
	//ResultSet rs=st.executeQuery("select * from result where roll_Num=?");
...
<body>
	...
	<!-- 	<h6>Note: Institution doesn't own for the errors or omissions, if
			any, in this statement. Designed & Developed by MCA Days Team</h6>
	 -->	
	</center>
	<hr class="new1">
	<center>
		<h6>All Right Reserved @ MCA Days :: 2015-2020</h6>
	</center>
	<hr class="new1">
</body>
